...
public class MemberTestRepository extends Querydsl4RepositorySupport {
    ...
    public Page<Member> searchPageByApplyPage(MemberSearchCondition condition, Pageable pageable){
        ...
        JPAQuery<Long> countQuery = select(member.count()).from(member).where(
                usernameEq(condition.getUsername()),
                teamNameEq(condition.getTeamName()),
                ageGoe(condition.getAgeGoe()),
                ageLoe(condition.getAgeLoe())
    ...
    public Page<Member> appliyPagination(MemberSearchCondition condition, Pageable pageable){
    ...
    public Page<Member> appliyPagination2(MemberSearchCondition condition, Pageable pageable){
